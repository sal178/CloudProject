...
namespace MyWebsite
{
    public partial class SetPrice : System.Web.UI.Page
    {
        ...
        protected void SignUp_btn_Click(object sender, EventArgs e)
        {
            ...
            if (room_no.Text.ToString() == "" ||  price.Text.ToString() == "" )
            {
                string message = "Please Enter Data In Both Fields";
            ...
            int flag = DALobj.SetPrice(roomno1, price1);


            if (flag == 1)
            {
                string message = "Price Sucessfully Updated!";
                System.Text.StringBuilder sb = new System.Text.StringBuilder();
                sb.Append("<script type = 'text/javascript'>");
                sb.Append("window.onload=function(){");
                sb.Append("alert('");
            ...
            {
                string message = "Operation Failed! Please enter correct data or try another room";
                System.Text.StringBuilder sb = new System.Text.StringBuilder();
                sb.Append("<script type = 'text/javascript'>");
                sb.Append("window.onload=function(){");
                sb.Append("alert('");
